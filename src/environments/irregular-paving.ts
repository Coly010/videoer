...
export function createHistoricSettPavingDefinition(): IrregularPavingDefinition {
  return irregularPavingDefinitionSchema.parse({
    ...
    courses: {
      directionDegrees: 0,
      nominalWidthMeters: 0.34,
      widthVariation: 0.2,
      staggerFraction: 0.48,
      edgeJitterMeters: 0.018,
    },
    units: {
      profile: 'irregular-sett',
      nominalLengthMeters: 0.42,
      lengthVariation: 0.26,
      widthVariation: 0.18,
      cornerJitterMeters: 0.018,
      yawVariationDegrees: 3.8,
      settlementMeters: 0.012,
      tiltDegrees: 1.25,
      heightMeters: 0.09,
      chamferMeters: 0.012,
      chipProbability: 0.22,
      maximumChipDepthMeters: 0.009,
    },
    joints: { widthMeters: 0.025, depthMeters: 0.018, materialId: 'dark-grit-joint' },
    borders: [
      {
        id: 'shop-kerb',
        kind: 'kerb',
...
export function createContemporaryPaverDefinition(): IrregularPavingDefinition {
  return irregularPavingDefinitionSchema.parse({
    ...
    courses: {
      directionDegrees: 90,
      nominalWidthMeters: 0.46,
      widthVariation: 0.1,
      staggerFraction: 0.34,
      edgeJitterMeters: 0.008,
    },
    units: {
      profile: 'irregular-paver',
      nominalLengthMeters: 0.68,
      lengthVariation: 0.14,
      widthVariation: 0.1,
      cornerJitterMeters: 0.009,
      yawVariationDegrees: 1.8,
      settlementMeters: 0.006,
      tiltDegrees: 0.65,
      heightMeters: 0.075,
      chamferMeters: 0.008,
      chipProbability: 0.08,
      maximumChipDepthMeters: 0.005,
    },
    joints: { widthMeters: 0.018, depthMeters: 0.012, materialId: 'polymeric-dark-joint' },
    borders: [
      {
        id: 'channel-drain',
        kind: 'gutter',
