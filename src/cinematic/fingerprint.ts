...
export async function fingerprintCinematicScene(sceneFile: string) {
  ...
  const dependencies = [
    ...scene.entities.flatMap((entity) => [
      ...
      ...(entity.surfaceWaterReceiverAppearancePath
        ? [
            {
              role: `surface-water-receiver-appearance:${entity.id}`,
              path: resolve(directory, entity.surfaceWaterReceiverAppearancePath),
            },
          ]
        : []),
      ...
      ...(entity.surfaceWaterOpticalSurfacePath
        ? [
            {
              role: `surface-water-optical:${entity.id}`,
              path: resolve(directory, entity.surfaceWaterOpticalSurfacePath),
            },
          ]
        : []),
    ]),
  ...
  const renderInputs = {
    ...
    entities: scene.entities.map((entity) => ({
      ...
      ...(entity.surfaceWaterReceiverAppearancePath
        ? {
            surfaceWaterReceiverAppearancePath: `artifact:surface-water-receiver-appearance:${entity.id}`,
          }
        : {}),
      ...(entity.surfaceHistoryFieldPath
      ...
      ...(entity.surfaceWaterOpticalSurfacePath
        ? {
            surfaceWaterOpticalSurfacePath: `artifact:surface-water-optical:${entity.id}`,
          }
        : {}),
    })),
    camera: scene.camera,
