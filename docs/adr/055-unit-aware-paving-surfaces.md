...
Research on 2026-09-01 reviewed ambientCG, Poly Haven, MaterialX, OpenPBR, Blender named attributes and OpenUSD primvars. ambientCG was the first cleared CC0 source. At the time of this decision, contradictory Poly Haven API terms blocked new automated live ingestion. Poly Haven reconciled those terms on 2026-07-18; ADR 067 records the subsequently reviewed exact terms and provider-file adapter. MaterialX's distance-unit and geometric-property vocabulary, Khronos texture-transform semantics and OpenUSD interpolation domains are useful references; Videoer's JSON remains authoritative. Blender-specific random-per-island, pointiness or topology indices cannot define portable surface identity.
