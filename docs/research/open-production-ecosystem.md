...
| HDRI/material/environment | [Poly Haven licence](https://polyhaven.com/license), [public API](https://polyhaven.com/our-api) | CC0 assets; live API terms separately reviewed | HDRIs, PBR materials, props and architectural/environment models | Use the API rather than scraping; show visible Poly Haven credit during live API use; persist source/version/licence/hash metadata and render probes |
...
- [Poly Haven API announcement](https://polyhaven.com/our-api), [API terms](https://github.com/Poly-Haven/Public-API/blob/master/ToS.md), and [API repository](https://github.com/Poly-Haven/Public-API): Poly Haven reconciled its terms on 2026-07-18. The exact terms reviewed at commit `df4d579935b5e245b2a745635607b6a3c595d8dd` permit commercial API use without a key or paid licence, require one identifying User-Agent or Referer, and require visible Poly Haven credit while the live service is used. Downloaded assets remain CC0 without attribution. ADR 067 records the fail-closed adapter decision; any change from the pinned ToS SHA-256 requires a new explicit review before live API use.
